...
exports["default"] = function (styles) {
            ...
            },
            {
                ...
                value: function overlayClick() {
                    if (
                        ...
                        (typeof this.props.disableOverlayClick === "function" && this.props.disableOverlayClick())
                    ) {
                        return;
                    } else {
                        this.close();
    ...
    Menu.propTypes = {
        ...
        outerContainerId:
            styles && styles.outerContainer ? _propTypes2["default"].string.isRequired : _propTypes2["default"].string,
        overlayClassName: _propTypes2["default"].string,
        pageWrapId:
            styles && styles.pageWrap ? _propTypes2["default"].string.isRequired : _propTypes2["default"].string,
