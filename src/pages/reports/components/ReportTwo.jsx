                ...
                <div className="flex flex-wrap">
                    <div className="xs:w-full sm:w-full md:w-1/3 lg:w-1/3 pr-4">
                        <div className="sm:w-full xs:w-full bg-tablerow flex justify-center items-center">
                            <Label description="1" />
                            <div className="flex justify-between w-2/3">Estatística de eventos
                    ...
                    <div className="sm:w-full xs:w-full flex justify-center items-center border-double">
                        <object width="900" height="500" data="http://localhost:8000/assets/pdf/event_statistic-10-11-2021 11:11:53.pdf" type="application/pdf">   </object>
                    </div>
                    <div className="text-right">
