...
const ShowFuel = props => {
    ...
    const getFuel = () => {
        setLoad(true);
        api.get(`api/adm/fuel-quote/${props.match.params.identifier}/show`, HeaderToken())
            .then(response => {
                ...
                {load ? (
                    ...
                    <Formik
                        ...
                        onSubmit={(values, { setSubmitting }) => {
                            api.post(
                                `api/adm/fuel-quote/${props.match.params.identifier}/edit`,
                                {
                                    ...values,
                                ...
                                .then(() => {
                                    toast.info("Cotação editada com sucesso!");
                                    setSubmitting(false);
                                    setActiveEdit();
                                })
                                .catch(error => {
                                        ...
                                        <div className="sm:w-full xs:w-full bg-tablerow flex justify-center items-center">
                                            ...
                                            <div className="flex justify-between w-2/3">
                                                {activeEdit === "value" ? (
                                                    ...
                                                    <>
                                                        <Information description={values.value} />
                                                        <Pencil setInputActive={() => setInputActive("value")} />
                                                    </>
                                                )}
                                            </div>
                                        </div>
