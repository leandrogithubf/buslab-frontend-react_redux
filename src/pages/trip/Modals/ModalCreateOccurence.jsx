...
const ModalCreateOccurence = ({
    ...
    return (
        <ModalForm overflow onClose={actionModalPost} show={modalPost} title={<h4 className="mb-3">Cadastro de Ocorrências</h4>}>
            <Formik
                initialValues={{
                    comment: "",
                    action: "",
                ...
                {({ handleChange, handleSubmit, isSubmitting, errors, values, touched, handleBlur, setFieldValue }) => (
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex mt-4">
                            <div className="w-1/2 pr-2">
                                ...
                                <SelectStyle
                                    ...
                                    optionsMap={(() => {
                                        let options = [];
                                        if (filteredCategoryList && filteredCategoryList.length > 0) {
                                ...
                                {touched.category && errors.category && (
                                    <span className="text-red-600 text-sm mt-0">{errors.category}</span>
                                )}
                            </div>
                            <div className="w-1/2 pl-2">
                        ...
                        <div className="flex mt-4">
                            ...
                            <div className="w-1/2 pl-2">
                                <label className="block text-gray-700 text-sm font-medium">Local</label>
                                <Input
                        ...
                        <label className="block text-gray-700 text-sm font-medium mt-4">Ações adotadas (Opcional)</label>
                        <textarea
                            className="resize-none w-full border text-gray-700 rounded focus:outline-none focus:bg-white -mb-2 p-2"
                            onChange={handleChange}
                            onBlur={handleBlur}
                        ...
                        <div className="flex mt-4">
                            <div className="w-1/2 pr-2">
                                <label className="block text-gray-700 text-sm font-medium">Data de término (Opcional)</label>
                                {errors.end}
                                <DatePickerWithHour
                                    selected={values.end}
                                    className="appearance-none w-full block text-gray-700 border border-gray-300 py-2 px-4 focus:outline-none focus:bg-white"
...
export default ModalCreateOccurence;
