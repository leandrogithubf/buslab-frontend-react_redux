...
const ListVehicles = ({ identifier }) => {
    ...
    const getVehicles = () => {
        setLoad(true);
        api.get(`api/adm/obd/${identifier}/vehicles`, HeaderToken())
            .then(response => {
            ...
            {load ? (
                ...
                <>
                    <div className="flex justify-between">
                        <h2 className="mb-5 font-light">Veículos do Obd</h2>
                    </div>
                    <div className="overflow-auto">
                        <table className="table-auto w-full">
                            ...
                            {vehiclesList.length > 0 && !load && (
                                <tbody>
                                    {vehiclesList.map((value, index) => {
                                        return (
                                            <tr
